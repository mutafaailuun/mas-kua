  ...
  <div style="font-family: 'Times New Roman', Times, serif; font-size: 12px; color: #000; background: #fff; width: 210mm; padding: 10mm 20mm 20mm 20mm; box-sizing: border-box;">
    ...
    <div style="text-align: center; margin-bottom: 14px;">
      <div style="font-size: 14px; font-weight: bold; text-transform: uppercase; letter-spacing: 0.5px;">
        Daftar Hadir Bimbingan Perkawinan Mandiri
      </div>
    </div>
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 11.5px; table-layout: fixed;">
      ...
      <thead>
        <tr style="background: #f5f5f5;">
          ...
          <th style="border: 1px solid black; padding: 7px 4px; text-align: center;">Tanggal Nikah</th>
      ...
      <tbody>
        <tr v-for="(p, i) in rows" :key="i" style="height: 42px;">
          ...
          <td style="border: 1px solid black; padding: 6px 4px; text-align: center; vertical-align: middle; font-size: 11px;">{{ p.tanggal_nikah ? formatTgl(p.tanggal_nikah) : '' }}</td>
          <td style="border: 1px solid black; padding: 6px 4px; text-align: center; vertical-align: middle; font-size: 11px;">{{ p.nama_suami ? tanggalBimwinFormatted : '' }}</td>
